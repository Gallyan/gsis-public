...
class EditPurchase extends Component
{
    ...
    protected function guest_rules()
    {
        return [
    ...
    public function add_reception()
    {
        ...
        if (! isset($this->rcpt_index)) {
            $this->rcpt_index = count($this->purchase_receptions);
        }
    ...
    public function edit_guest(int $rcpt_index, int $guest_id)
    {
        ...
        if ($guest_id < 0 || $guest_id >= count($guests)) {
            return;
        }
    ...
    public function del_list($rcpt_index)
    {
        ...
        if (! isset($this->purchase_receptions[$rcpt_index])) {
            return;
        }
    ...
    public function updated($propertyName)
    {
        ...
        } elseif (explode('.', $propertyName)[0] === 'list') {
