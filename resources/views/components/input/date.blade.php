<div
    ...
    x-init="new Pikaday({ field: $refs.input, format: 'YYYY-MM-DD', onOpen() { this.setDate($refs.input.value) }, firstDay: 1, yearRange: [1900, new Date().getFullYear()] })"
...
>
    ...
    <input
        ...
        x-ref="input"
        x-bind:value="value"
        class="rounded-none rounded-r-md flex-1 form-input block w-full transition duration-150 text-gray-700 ease-in-out sm:text-sm sm:leading-5"
    />
</div>
