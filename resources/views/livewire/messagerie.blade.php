        ...
        <div class="flow-root">
            <div class="relative pb-8">
                ...
                <div class="relative flex items-start space-x-3">
                    <div class="relative">
                        <img class="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center ring-1 ring-white" src="{{ auth()->user()->avatarUrl() }}" alt="{{ auth()->user()->name }}">
                    </div>
            ...
            <li>
                <div class="relative pb-8">
                    ...
                    <div class="relative flex items-start space-x-3">
                        <div class="relative">
                            <img class="h-10 w-10 rounded-full truncate flex items-center bg-gray-100 justify-center ring-1 ring-white" src="{{ $post->user()->first()->avatarUrl() }}" alt="{{ $post->user()->first()->name }}">
                        </div>
                        <div class="min-w-0 flex-1">
                            <div>
