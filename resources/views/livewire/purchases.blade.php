        ...
        <div class="flex-col space-y-4">
            <x-table>
                ...
                <x-slot name="body">
                    ...
                    <x-table.row wire:loading.class.delay="opacity-50" wire:key="row-{{ $purchase->id }}" wire:click="edit({{ $purchase->id }})" class="cursor-pointer hover:bg-gray-100 {{ $loop->even ? 'bg-cool-gray-50' : '' }}">
